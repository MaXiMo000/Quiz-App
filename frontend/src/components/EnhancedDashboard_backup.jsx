...
const EnhancedDashboard = () => {
  ...
  const categoryData = {
    labels: Object.keys(dashboardData.categoryPerformance).length > 0 
      ? Object.keys(dashboardData.categoryPerformance)
      : ['General', 'Science', 'History', 'Math', 'Literature'],
    datasets: [
      {
        data: Object.keys(dashboardData.categoryPerformance).length > 0
  ...
  // Error state - Remove this block to show fallback data instead
  // The component will now always render the dashboard with fallback data when there's an error
